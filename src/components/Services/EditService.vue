        ...
        <v-card :loading="get_loadService">
          ...
          <v-card-text v-if="get_Service!=null">
            ...
            <v-row>
              ...
              :rules="[rules.required]"
              label="Description"
              v-model="get_Service.description"
              outlined
            >
             </v-textarea>
              ...
              <v-col cols="12" md="4" sm="12" xs="12">
               ...
               <v-col cols="12" md="4" sm="12" xs="12">
                 <v-card :loading="get_loadEmployee" flat>
                   ...
                   <v-card-title>Skilled personail
                     <v-spacer>  </v-spacer>
                    ...
                    <v-checkbox v-model="emplo.isSelected" v-for="emplo in filteredEmployees" :key="emplo.id" :label="`${emplo.firstName} ${emplo.lastName}`"></v-checkbox>
                 </v-card>
               </v-col>
            </v-row>
          </v-card-text>
